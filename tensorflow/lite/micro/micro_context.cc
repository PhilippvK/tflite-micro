...
MicroInterpreterContext::MicroInterpreterContext(MicroAllocator* allocator, const Model* model,
                           MicroGraph* graph)
    : MicroContext(allocator, model, graph) {}
...
TfLiteStatus MicroInterpreterContext::RequestScratchBufferInArena(size_t bytes,
                                                       int* buffer_idx) {
...
int MicroInterpreterContext::GetTensorIndex(int index, int max_size,
...
TfLiteTensor* MicroInterpreterContext::AllocateTempInputTensor(const TfLiteNode* node,
                                                    int index) {
...
TfLiteTensor* MicroInterpreterContext::AllocateTempOutputTensor(const TfLiteNode* node,
                                                     int index) {
  const int tensor_index =
